    ...
    <div class="col-md-4 ">
        <div class="card text-start bg-transparent">
          ...
          <div class="p-3 mb-2 text-white rounded"><h1 class="display-5 fw-bold text-black">Modificar</h1></div>
            <form action="helpers/actualizarProducto.php" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="text-white form-label">Precio</label>
                    <input name="precio" type="number" value="<?php echo $row['precio'];?>" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="helpers/updImgProduct.php" method="post" enctype="multipart/form-data">
	        <div class="mb-3">
